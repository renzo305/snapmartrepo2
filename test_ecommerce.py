...
class createEmail(unittest.TestCase, Keywords):
    ...
    def setUp(self):
        ...
        self.driver = webdriver.Chrome(executable_path = "https://github.com/renzo305/snapmartrepo2/blob/circleci-project-setup/chromedriver.exe", options=self.options)
